...
const notesCreate = async (req, res) => {
    const { title, genre, director, releaseYear, body } = req.body;
    ...
    try {
        ...
        await Notesmodel.create({ title, body,genre, director, releaseYear, userId: req.user._id })
...
//   };
  ...
  //   }
  // };
module.exports = { notesCreate, notesDelete, getNotesbyUser, getSpecificUserNotes, updateNotes, }